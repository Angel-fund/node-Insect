...
@Param  file_url = 'http://www.sina.com/tmp.jpg';  
@Param dir = './downloads/'; 
*/
NodeGrass.prototype.download_file_curl =  function(file_url,dir,callback) {
    // extract the file name
    var file_name = url.parse(file_url).pathname.split('/').pop(), 
        file = fs.createWriteStream(dir + file_name),   
...
//@Param url
//@Param callback
NodeGrass.prototype.getProxy = function(url,callback, reqheaders, charset,proxy){
    var protocol = getProtocol(url);
    var _defaultCharSet = 'utf8';
    ...
    newheader["content-length"] = 0;
    var host = (proxy !== null)?proxy.host:getHost(url),
        port = (proxy !== null)?proxy.port:getHost(url);
    var options = {
        host:host,
        port:port,
        path:getPath(url),
